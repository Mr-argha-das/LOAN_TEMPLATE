...
export const Route = createFileRoute("/apply")({
  head: () => ({
    meta: [
      { title: "Apply for a Loan | Chola CSEL Loan Application" },
      {
        name: "description",
        content:
          "Apply online for a CSEL personal, professional or business loan. Quick processing, minimum documentation and face verification.",
      },
      { property: "og:title", content: "Apply for a Loan | Chola CSEL Loan Application" },
      {
