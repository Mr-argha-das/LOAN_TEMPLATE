  ...
  return (
    ...
    >
      ...
      <div className="border-b border-border bg-white/70">
        <div className="mx-auto flex w-full max-w-[1280px] items-center gap-2 px-4 py-2.5 text-[12px] text-muted-foreground">
          <Link to="/" className="hover:text-primary">
            Home
          </Link>
          <span>/</span>
          <span className="font-semibold text-primary">Apply Online</span>
        </div>
      </div>
